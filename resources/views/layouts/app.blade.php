...
<body x-data="themeSwitcher()" :class="{ 'dark': switchOn } relative">
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <footer class='z-10 flex flex-col items-center justify-center w-full px-2 py-12 bg-gray-300 border-t border-t-gray-300 dark:border-none dark:bg-slate-800'>
            ...
            <div class="flex flex-col items-center justify-center pb-4 text-center md:w-96">
                ...
                <div class='flex flex-col w-full gap-2'>
                    ...
                    <x-button outline primary icon='shopping-cart' href="{{ route('notes.payment.payment-index') }}"
                        label="{{ __('welcome.footer-4') }}" />
                </div>
            </div>
            <div class="text-sm text-center dark:text-gray-400 sm:text-start">
