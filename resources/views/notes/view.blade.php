<x-guest-layout>
    <div class='pt-5 px-4  flex flex-col justify-center items-center'>
        ...
        <main class='flex md:flex-row flex-col justify-center gap-6 pt-12 pb-32'>
            <div class='dark:text-gray-300 flex gap-4 md:max-w-96  w-full rounded-2xl items-start flex-col dark:bg-gray-950'>
                <div class='px-6 w-full sm:w-3/4 md:w-full pb-6'>
 
                    <div class='flex flex-col gap-2 mb-4'>
                        <div class='flex justify-center w-full h-full md:h-auto mb-1 py-6'>
                        ...
                        <p class='md:text-lg text-base'>{{ $note->area }}</p>no
                    </div>
            ...
            <div class='dark:text-gray-300 flex flex-col rounded-2xl dark:bg-gray-950 w-full md:w-8/12'>
                <div class='flex flex-col items-start gap-4 p-6 '>
                    <div>
                        <a class='flex items-center 2xl:text-3xl  gap-3 justify-center lg:text-xl text-base' href='#'>
                            <x-button icon="mail" /> Contact me
                        </a>
                    </div>
                    <div class='lg:text-xl 2xl:text-3xl text-base'><strong>My degree:</strong> Economics and Business</div>
                    <div class='lg:text-xl 2xl:text-3xl  text-base'><strong>About me:</strong> Economics and BusinessEconomics and
