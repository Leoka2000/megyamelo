...
<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
               {{ __('profilez.profile7') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('profilez.profile8') }}
        </p>
    </header>

    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            <x-input-label for="update_password_current_password" :value="__('profilez.profile9')" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('profilez.profile10')" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('profilez.profile11')" />
        ...
        <div class="flex items-center gap-4">
            <x-primary-button>{{ __('profilez.profile6')}}</x-primary-button>

            <x-action-message class="me-3" on="password-updated">
                 {{ __('profilez.profile22') }}
            </x-action-message>
        </div>
    </form>
</section>
