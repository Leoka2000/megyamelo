<div
    class="z-20 flex items-center justify-between w-full h-20 pr-2 border-b border-gray-700 sm:fixed sm:top-0 sm:right-0 text-end bg-slate-900">
    <a href="{{ route('dashboard') }}" wire:navigate>
        <div class='flex items-center justify-center mt-2 w-36'>
            <img class='object-cover w-full h-full rounded-md' src="{{ asset('logo-top.png') }}" alt="sheesh"
                title="sheesh" />
        </div>
    </a>
    @auth
